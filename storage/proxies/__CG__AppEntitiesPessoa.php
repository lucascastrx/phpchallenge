 ...
 */
class Pessoa extends \App\Entities\Pessoa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Pessoa' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Pessoa' . "\0" . 'nome', '' . "\0" . 'App\\Entities\\Pessoa' . "\0" . 'cpf'];
        }
